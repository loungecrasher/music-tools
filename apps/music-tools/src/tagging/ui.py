...
from rich.progress import (
    Progress, BarColumn, TaskProgressColumn, TimeRemainingColumn, 
    SpinnerColumn, TextColumn, TimeElapsedColumn, MofNCompleteColumn,
    DownloadColumn
)
        ...
        with self._lock:
            ...
            if self.progress and self.main_task is not None:
                ...
                if self.data.current_speed > 0:
                    ...
                    speed_text = f"[dim]calculating speed...[/dim]"
