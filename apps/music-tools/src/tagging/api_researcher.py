...
class APIResearcher:
    ...
    def __init__(self, api_key: str = None, model: str = "claude-3-5-sonnet-20241022",
                 max_retries: int = 3, timeout: int = 30, cache_manager=None):
        """
    ...
    def research_artists_batch(self, artists_titles: List[Tuple[str, str]]) -> Dict[str, Dict[str, str]]:
        """
        ...
        try:
            ...
            for line in lines:
                ...
                if numbered_match:
                    ...
                    if current_artist_idx >= 0 and current_artist_idx < len(artists_titles) and current_artist_data:
