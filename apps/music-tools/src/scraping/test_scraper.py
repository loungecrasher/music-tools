...
from .models import (
    BlogPost, DownloadLink, Genre, ScraperConfig, 
    ScraperResult, LinkExtractionResult, validate_post_data
)
from .error_handling import (
    exponential_backoff, rate_limit_handler, 
    create_resilient_session, validate_url
)
...
class TestIntegration:
    ...
    def test_complete_scraping_flow(self, mock_find_posts, mock_get_page, 
                                   scraper, sample_html, tmp_path):
        ...
        matching_posts = scraper.filter_posts_by_genre(
            post_urls, 
