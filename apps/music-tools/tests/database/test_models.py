...
class TestTrackModel:
    ...
    def test_track_defaults(self):
        ...
        track = Track(
            id="tr_001", name="Song Title", artist="Artist Name", service=ServiceType.SPOTIFY
        )
    ...
    def test_track_validation(self):
        ...
        # Empty name should fail
        with pytest.raises(ValidationError):
            Track(id="tr_001", name="", artist="Artist", service=ServiceType.SPOTIFY)

        # Empty artist should fail
        with pytest.raises(ValidationError):
            Track(id="tr_001", name="Song", artist="", service=ServiceType.SPOTIFY)

        # Negative duration should fail
        with pytest.raises(ValidationError):
            Track(
                id="tr_001", name="Song", artist="Artist", duration=-1, service=ServiceType.SPOTIFY
            )
...
class TestPlaylistTrackModel:
    ...
    def test_valid_playlist_track(self):
        ...
        pt = PlaylistTrack(playlist_id="pl_001", track_id="tr_001", position=1)
    ...
    def test_playlist_track_defaults(self):
        ...
        pt = PlaylistTrack(playlist_id="pl_001", track_id="tr_001")
    ...
    def test_playlist_track_validation(self):
        ...
        with pytest.raises(ValidationError):
            PlaylistTrack(playlist_id="pl_001", track_id="tr_001", position=-1)
...
class TestSettingModel:
    ...
    def test_valid_setting(self):
        ...
        setting = Setting(key="api_key", value="secret123")
    ...
    def test_setting_complex_value(self):
        ...
        setting = Setting(key="config", value={"option1": True, "option2": "value"})
...
class TestArtistCountryModel:
    ...
    def test_valid_artist_country(self):
        ...
        ac = ArtistCountry(artist_name="Daft Punk", country="France", confidence=0.95)
    ...
    def test_artist_country_defaults(self):
        ...
        ac = ArtistCountry(artist_name="The Beatles", country="United Kingdom")
    ...
    def test_artist_country_validation(self):
        ...
        with pytest.raises(ValidationError):
            ArtistCountry(artist_name="Artist", country="Country", confidence=1.5)

        # Negative hit_count should fail
        with pytest.raises(ValidationError):
            ArtistCountry(artist_name="Artist", country="Country", hit_count=-1)
