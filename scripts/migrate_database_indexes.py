...
def migrate_library_database(db_path: str) -> Tuple[int, int]:
    ...
    try:
        ...
        logger.info(
            f"Library database migration complete: {added} indexes added, {existing} already existed"
        )
...
def migrate_common_database(db_path: str) -> Tuple[int, int]:
    ...
    try:
        ...
        logger.info(
            f"Common database migration complete: {added} indexes added, {existing} already existed"
        )
        return (added, existing)
...
def migrate_cache_database(db_path: str) -> Tuple[int, int]:
    ...
    try:
        ...
        logger.info(
            f"Cache database migration complete: {added} indexes added, {existing} already existed"
        )
        return (added, existing)
