...
print(
    f"Working: {len(results['internal_links']['working'])} ({len(results['internal_links']['working'])/results['internal_links']['total']*100:.1f}%)"
)
print(
    f"Broken: {len(results['internal_links']['broken'])} ({len(results['internal_links']['broken'])/results['internal_links']['total']*100:.1f}%)"
)
print()
...
print(
    f"Valid: {len(results['code_references']['valid'])} ({len(results['code_references']['valid'])/results['code_references']['total']*100:.1f}%)"
)
print(
    f"Invalid: {len(results['code_references']['invalid'])} ({len(results['code_references']['invalid'])/results['code_references']['total']*100:.1f}%)"
)
print()
