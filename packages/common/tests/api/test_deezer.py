...
class TestDeezerClientRequests:
    ...
    def test_get_track_success(self, mock_get):
        ...
        mock_get.assert_called_once_with("https://api.deezer.com/track/3135556", params=None)
    ...
    def test_search_tracks(self, mock_get):
        ...
        mock_get.assert_called_once_with("https://api.deezer.com/search/track", params=params)
    ...
    def test_get_artist_albums(self, mock_get):
        ...
        mock_response.status_code = 200
        mock_response.json.return_value = {
            "data": [{"id": 1, "title": "Album 1"}, {"id": 2, "title": "Album 2"}],
            "total": 2,
        }
        mock_get.return_value = mock_response
...
class TestDeezerClientDataRetrieval:
    ...
    def test_search_with_strict_mode(self, mock_get):
        ...
        mock_response = Mock()
        mock_response.status_code = 200
        mock_response.json.return_value = {"data": [{"id": 1, "title": "Exact Match"}]}
        mock_get.return_value = mock_response
    ...
    def test_search_artist(self, mock_get):
        ...
        mock_response.status_code = 200
        mock_response.json.return_value = {
            "data": [{"id": 1, "name": "Artist 1"}, {"id": 2, "name": "Artist 2"}]
        }
        mock_get.return_value = mock_response
    ...
    def test_get_genre_artists(self, mock_get):
        ...
        mock_response.status_code = 200
        mock_response.json.return_value = {
            "data": [{"id": 1, "name": "Rock Artist 1"}, {"id": 2, "name": "Rock Artist 2"}]
        }
        mock_get.return_value = mock_response
    ...
    def test_get_chart_tracks(self, mock_get):
        ...
        mock_response.json.return_value = {
            "tracks": {
                "data": [{"id": 1, "title": "Chart Track 1"}, {"id": 2, "title": "Chart Track 2"}]
            }
        }
        mock_get.return_value = mock_response
    ...
    def test_get_editorial_selection(self, mock_get):
        ...
        mock_response.status_code = 200
        mock_response.json.return_value = {
            "data": [{"id": 1, "name": "Editorial 1"}, {"id": 2, "name": "Editorial 2"}]
        }
        mock_get.return_value = mock_response
    ...
    def test_get_radio_list(self, mock_get):
        ...
        mock_response.status_code = 200
        mock_response.json.return_value = {
            "data": [{"id": 1, "title": "Radio 1"}, {"id": 2, "title": "Radio 2"}]
        }
        mock_get.return_value = mock_response
...
class TestDeezerClientEdgeCases:
    ...
    def test_unicode_in_search(self, mock_get):
        ...
        mock_response = Mock()
        mock_response.status_code = 200
        mock_response.json.return_value = {"data": [{"name": "Björk"}]}
        mock_get.return_value = mock_response
...
class TestDeezerClientIntegration:
    ...
    def test_search_and_get_details_workflow(self, mock_get):
        ...
        search_response.json.return_value = {"data": [{"id": 3135556, "title": "Test Track"}]}
    ...
    def test_artist_exploration_workflow(self, mock_get):
        ...
        artist_response.json.return_value = {"id": 27, "name": "Daft Punk"}

        # Artist albums
        albums_response = Mock(status_code=200)
        albums_response.json.return_value = {"data": [{"id": 302127, "title": "Discovery"}]}
